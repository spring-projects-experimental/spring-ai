...
public class DeepSeekChatProperties extends DeepSeekParentProperties {
	...
	private String betaFeaturePath = DEFAULT_BETA_PATH;
	...
	public String getBetaFeaturePath() {
		return betaFeaturePath;
	}

	public void setBetaFeaturePath(String betaFeaturePath) {
